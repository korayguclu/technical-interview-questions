...
## Describe wsimport tool

You can use wsimport tool to generate client side java classes for a given WS endpoint as shown below.
```
wsimport -clientjar wsclient.jar http://example.com/webservice/endpoint?WSDL
```
